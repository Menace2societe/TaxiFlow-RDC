      ...
      <div className="w-full max-w-[360px]">
        ...
        <div className="bg-[#12121e] border border-[#2a2a40] rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-[#94a3b8] mb-1.5">Nom complet</label>
              <input
                type="text" value={fullName} onChange={e => setFullName(e.target.value)}
                required placeholder="Jean Mukeba"
          ...
          <p className="text-center text-sm text-[#64748b] mt-5">
            Déjà un compte ?{" "}
            <Link href="/login" className="text-[#7c63f5] hover:text-[#9580ff] font-medium">Se connecter</Link>
          </p>
        </div>
      </div>
    </div>
