  ...
  return (
    <div className="space-y-8 p-4 bg-[#0a0a0c] min-h-screen text-white">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black italic tracking-tighter">PORTAIL CHAUFFEUR</h1>
          <p className="text-slate-300">Interface de gestion des partenaires.</p>
        </div>
        <button 
      ...
      {showForm && (
        <form onSubmit={handleRecruit} className="bg-[#121214] border-2 border-[#7c63f5] p-6 rounded-[32px] space-y-4">
          <input 
            value={name} 
        ...
        {drivers.map((d) => (
          <div key={d.id} className="bg-[#121214] border border-slate-800 p-6 rounded-[32px]">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center font-black text-white">DR</div>
              <div>
